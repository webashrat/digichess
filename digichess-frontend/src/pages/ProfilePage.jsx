                        ...
                        <div className="relative">
                            ...
                            <div className="relative px-4 pt-6 pb-4 flex flex-col items-center">
                                <div className="relative mb-4">
                                    ...
                                    <div className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-[3px] border-white dark:border-slate-800 ${isSelf || displayUser?.is_online ? 'bg-green-500' : 'bg-red-500'}`} />
                                </div>
